<template>
  <dv-border-box-12>
    <div class=""
      ...
      <div class="module-title" style="margin-bottom: 10px">车辆到场及放行信息统计</div>
...
export default {
  ...
  created() {
    ...
    for (let currentDate = startDate; currentDate <= endDate; currentDate.setDate(currentDate.getDate() + 1)) {
      ...
      option.series[0].data.push(Math.random() * 8)
      option.series[1].data.push(Math.random() * 8)
      option.series[2].data.push(Math.random() * 8)
    }
