<template>
  <dv-border-box-3 :color="['#234d84','#031694']">
    <div
      style="padding:20px;display: flex;flex-direction: column;justify-content: space-around;height: 100%;box-sizing: border-box">
      <div style="display: flex;align-items: stretch;justify-content: space-around">
        <div style="display: flex;flex-direction: column;justify-content: space-between;align-items: center">
          <div style="display: flex;flex-direction: column;justify-content: space-between;align-items: center">
            <div style="font-weight: bold;font-size: 40px;color:#00c0ff">车间连续安全生产</div>
            <dv-decoration-3 style="width:200px;height:20px;"/>
          </div>
          <div style="display: flex;flex-direction: column;align-items: center;">
            <div style="font-size: 24px;color: #00c0ff;font-weight: bold;">2023年8月1日 - 2024年8月1日</div>
            <dv-decoration-5 style="width:300px;height:20px;" :dur="10"/>
          </div>
        </div>
        <!--<dv-decoration-11 style="width:200px;height:60px;">2023年8月1日 - 2024年8月1日</dv-decoration-11>-->

        <dv-decoration-9 :dur="10" style="width:130px;height:130px;color: #00c0ff;font-weight: bold;font-size: 20px;">
          366天
        </dv-decoration-9>
