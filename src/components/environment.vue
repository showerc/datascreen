<template>
  <dv-border-box-12>
    <div class=""
      ...
      <div
        style="width: 100%;display: flex;justify-content: center;padding:0 40px;align-items: center;box-sizing: border-box;flex-wrap: wrap;align-content: center;row-gap: 20px;column-gap: 10px">
        <dv-border-box-13 style="width:180px;height:100px;" class="text-box">
